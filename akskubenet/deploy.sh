...
az aks create -n jjakskubenet -g $rgaks \
    ...
    --vnet-subnet-id $(az network vnet subnet show --vnet-name JJDevV2NetworkApp -g $rg -n DmzAks --query id -o tsv) \
...
# Deploy application using loadbalancer
#kubectl apply -f sample-vote.yaml
